...
export default function Developers() {
    ...
    return (
        <Container className='mt-4'>
            <h1 className='mb-4'>Senior Developer (4587)</h1>
            <Table striped className="mx-auto" style={{ width: '90%'}} responsive>
                ...
                <tbody>
                    {developerData.map((developer, index) => (
                        <tr key={index} >
                            <td className='p-4'>{developer.name}</td>
                            <td className='p-4'>{developer.email}</td>
                            <td className='p-4'>{developer.contactNumber}</td>
                            <td className='p-4'>{developer.appliedDate}</td>
                            <td className='p-4'><a href={developer.resumeLink} target="_blank" rel="noopener noreferrer">File</a></td>
                        </tr>
                    ))}
                </tbody>
            </Table>
