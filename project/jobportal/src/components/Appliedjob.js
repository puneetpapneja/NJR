...
<Col lg={6} style={{marginLeft:"350px"}}>
 ...
 <Card style={{marginTop:"20px"}}>
      ...
      <Card.Header as="h5">developer</Card.Header>
      
      <Card.Body>
        <Card.Title>Description</Card.Title>
        <Card.Text>
         Numquam itaque sunt optio vel blanditiis dolore incidunt recusandae nesciunt accusantium ea voluptas eum temporibus unde, architecto quod non perspiciatis ratione eaque.
        </Card.Text>
        <Row>
          <Col>
